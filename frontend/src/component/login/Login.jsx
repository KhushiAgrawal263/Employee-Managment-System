        ...
        <div className='userIcon'>
          <div>
            <div className='admin' onClick={()=>roleHandler('admin')}>
              <img className='img1' src="https://img.icons8.com/ios-filled/100/null/admin-settings-male.png"/>
              Admin
            </div>
              {
                role === 'admin'  ? <img className='tick' src="https://img.icons8.com/ios-glyphs/30/null/checked.png"/> : ''
              }
          </div>

          <div>
            <div className='user' onClick={()=>roleHandler('user')}>
                <img className='img1' src="https://img.icons8.com/ios-filled/100/null/user.png"/>
                Employee
            </div>
              {
                role === 'user'  ? <img className='tick' src="https://img.icons8.com/ios-glyphs/30/null/checked.png"/> : ''
              }
