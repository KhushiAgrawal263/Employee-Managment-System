...
const Apply = () => {
    ...
    const handleSubmit =async (event) => {
        ...
        const val = {
            ...
            empId:user.empId,
            pending:{ 
                leaveType:leaveType, dates:array, reason:reason, status:"pending"
            }
        }
                ...
                <div className="applycal">
                    <div className="cal ">
                        <Calendar 
                            ...
                            tileClassName={({ date, view }) => {
                                if(pending.find(x=>x===moment(date).format("DD-MM-YYYY"))){
                                return  'highlight1'
                                }else {
                                    if(approved.find(x=>x===moment(date).format("DD-MM-YYYY"))){
                                        return 'highlight4'
                                    }
                                }
                            }}
                    ...
                    <div className='holidayColor'>
                        <div className='holidays'>
                            <div className='hdiv greenDiv'></div> <div className ="RLeave">Approved Leave</div>
                        </div>

                        <div className='holidays'>
                            <div className='hdiv redDiv'></div> <div className ="RLeave">Pending Leave</div>
                        </div>
                        <div className='holidays'>
                            <div className='hdiv blueDiv'></div> <div className ="RLeave">Today</div>
                        </div>
                ...
                <div className='leaveBox'>
                    <form >
                        <div className='BoxDate'>
                            ...
                            <div className='detailReason' name="reason" onChange={(e)=>setReason(e.target.value)}>
                        ...
                        <div className='leaveButton'>
                            ...
                            {/* <button type="button" class="btn btn-outline-primary">Reset All</button> */}
                        </div>
                    </form>
                </div>
            </div>
